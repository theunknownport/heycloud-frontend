...
var UploadList = /** @class */ (function (_super) {
    ...
    UploadList.prototype.mapListGroups = function () {
        ...
        return Object
            ...
            return (React.createElement(UploadListGroup_1.UploadListGroup, __assign({ key: key, files: files, index: index, navigationIndex: navigationIndex }, others)));
        });
    };
    UploadList.prototype.render = function () {
        var ulClassName = (0, kendo_react_common_1.classNames)('k-upload-files', 'k-reset');
