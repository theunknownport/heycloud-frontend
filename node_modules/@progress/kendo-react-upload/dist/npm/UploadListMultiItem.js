...
var UploadListMultiItem = /** @class */ (function (_super) {
    ...
    UploadListMultiItem.prototype.render = function () {
        ...
        var itemClassName = (0, kendo_react_common_1.classNames)('k-file-multiple');
        ...
        return (React.createElement("div", { className: itemClassName },
            ...
            React.createElement("span", { className: "k-multiple-files-wrapper" },
                ...
                !isUploadFailed ?
                    (progress !== 100 ?
                        (React.createElement("span", { className: 'k-file-information' }, "".concat(totalMessage, ": ").concat(files.length, " ").concat(filesMessage, ", ").concat(utils_1.default.getTotalFilesSizeMessage(files)))) :
