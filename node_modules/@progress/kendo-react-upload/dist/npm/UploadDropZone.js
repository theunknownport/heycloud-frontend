...
var UploadDropZone = /** @class */ (function (_super) {
    ...
    UploadDropZone.prototype.render = function () {
        ...
        var className = (0, kendo_react_common_1.classNames)('k-dropzone', this.documentActive ? 'k-dropzone-active' : '', this.elementActive ? 'k-dropzone-hovered' : '');
        ...
        var dropZoneClassName = (0, kendo_react_common_1.classNames)('k-dropzone-hint', {
...
(0, kendo_react_intl_1.registerForLocalization)(UploadDropZone);
