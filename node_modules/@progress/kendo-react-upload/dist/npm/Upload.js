        ...
        _this.uploadFiles = function (filesForUpload) {
            ...
            stateUtils_1.default.groupForEach(filesForUpload, function (currentFiles, uid) {
                ...
                if (_this.isCustomSave) {
                    ...
                    (0, axios_1.default)(__assign(__assign({ method: async.saveMethod, url: async.saveUrl, data: formData, cancelToken: cancelTokenSource.token }, requestOptions), { onUploadProgress: function (event) { return _this.onUploadProgress(uid, event); } }))
        ...
        _this.removeFiles = function (filesForRemove) {
            ...
            stateUtils_1.default.groupForEach(filesForRemove, function (currentFiles, uid) {
                ...
                if (_this.isCustomRemove) {
                    ...
                    (0, axios_1.default)(__assign({ method: async.removeMethod, url: async.removeUrl, data: formData }, requestOptions))
