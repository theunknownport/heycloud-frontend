...
var deflateWorkerSingleton_1 = require("../domain/segmentCollection/deflateWorkerSingleton");
function makeRecorderApi(startRecordingImpl, getDeflateWorkerSingletonImpl) {
    if (getDeflateWorkerSingletonImpl === void 0) { getDeflateWorkerSingletonImpl = deflateWorkerSingleton_1.getDeflateWorkerSingleton; }
    var state = {
        status: 0 /* Stopped */,
    };
