...
const DashboardWidgeds = () => {
    return (
        <div class="row">
            <div class="col-md-6 col-xl-3 offset-xl-0 mb-4">
                <div class="card shadow border-start-primary py-2">
                    <div class="card-body">
                        <div class="row align-items-center no-gutters">
                            <div class="col me-2">
                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Vps created</span></div>
                                <div class="text-dark fw-bold h5 mb-0"><span>10</span></div>
                            </div>
                            <div class="col-auto"><i class="fa fa-server" style={{'transform': 'scale(2.43)'}}></i></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3 offset-xl-0 mb-4">
                <div class="card shadow border-start-primary py-2">
                    <div class="card-body">
                        <div class="row align-items-center no-gutters">
                            <div class="col me-2">
                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Websites created</span></div>
                                <div class="text-dark fw-bold h5 mb-0"><span>10</span></div>
                            </div>
                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style={{'transform': 'scale(2.43)'}}>
            ...
            <div class="col-md-6 col-xl-3 offset-xl-0 mb-4">
                <div class="card shadow border-start-primary py-2">
                    <div class="card-body">
                        <div class="row align-items-center no-gutters">
                            <div class="col me-2">
                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>ports forwarded</span></div>
                                <div class="text-dark fw-bold h5 mb-0"><span>10</span></div>
                            </div>
                            <div class="col-auto"><i class="fa fa-wifi" style={{'transform': 'scale(2.43)'}}></i></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default DashboardWidgeds
